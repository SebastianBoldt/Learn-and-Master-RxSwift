...
> Everything in Rx is an Observable Sequence and a thing that works with a observable sequence.
...
* You can also add the subscription to a disposebag which will cancel the description for yu automatically on deinit
